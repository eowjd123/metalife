        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '24px' }}>
          <div style={{ background: 'white', padding: '24px', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: 'var(--radius-md)', background: 'var(--primary-100)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary-600)" strokeWidth="2">
                  <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path>
                </svg>
              </div>
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: 'var(--gray-600)', margin: 0 }}>총 라이선스</h3>
                <p style={{ fontSize: '24px', fontWeight: 700, color: 'var(--gray-900)', margin: 0 }}>{stats.total.toLocaleString()}</p>
              </div>
            </div>
          </div>
          <div style={{ background: 'white', padding: '24px', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: 'var(--radius-md)', background: 'var(--success-100)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div>
                <h3 style={{ fontSize: '14px', fontWeight: 600, color: 'var(--gray-600)', margin: 0 }}>활성 라이선스</h3>
                <p style={{ fontSize: '24px', fontWeight: 700, color: 'var(--gray-900)', margin: 0 }}>{stats.active.toLocaleString()}</p>
              </div>
            </div>
          </div>
          <div style={{ background: 'white', padding: '24px', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}>
              ...
              {licenses.length > 0 ? (
                ...
                <tr>
                  <td colSpan={10} style={{ padding: '60px', textAlign: 'center' }}>
                    ...
                    <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--gray-700)', marginBottom: '8px' }}>라이선스 데이터가 없습니다</h3>
